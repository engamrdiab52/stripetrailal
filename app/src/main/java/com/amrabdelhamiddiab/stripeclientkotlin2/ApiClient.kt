...
import com.amrabdelhamiddiab.stripeclientkotlin2.MainActivity.Companion.BACKEND_URL
import com.amrabdelhamiddiab.stripeclientkotlin2.MainActivity.Companion.TAG
import okhttp3.*
...
class ApiClient {
    ...
    fun createPaymentIntent(
        ...
        val request = Request.Builder().url(BACKEND_URL + "create-payment-intent").post(body).build()
